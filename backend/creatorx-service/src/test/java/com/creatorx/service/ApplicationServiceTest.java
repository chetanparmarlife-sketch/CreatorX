...
class ApplicationServiceTest {
        ...
        void setUp() {
                ...
                // Mock KYC service to return verified for all creators so tests can reach
                // duplicate/other checks
                lenient().when(kycService.isKYCVerified(anyString())).thenReturn(true);
        }
