...
@Table(name = "applications", indexes = {
        @Index(name = "idx_applications_campaign_id", columnList = "campaign_id"),
        @Index(name = "idx_applications_creator_id", columnList = "creator_id"),
        ...
        @Index(name = "idx_applications_status_applied_at", columnList = "status,applied_at")
})
@Data
@SuperBuilder
@NoArgsConstructor
